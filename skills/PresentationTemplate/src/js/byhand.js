...
const ByHand = (() => {
  ...
  const STEPS = [
    ...
    { time:"14:52", dur:"4m", sys:"edr", side:"left",
      ...
      comment:"EDR searches show the extension is installed on at least 93 devices in Tesco.",
    ...
    { time:"15:38", dur:"11m", sys:"splunk", side:"right",
      ...
      results:{ cols:["User","Requests"], rows:[
        ["alice.best@tesco.com","4"],
        ["charlie.doone@tesco.com","2"],
    ...
    { time:"16:07", dur:"10m", sys:"splunk", side:"right",
      ...
      results:{ cols:["User","Action","Count"], rows:[
        ["elliot.foster@tesco.com","allowed","2"],
